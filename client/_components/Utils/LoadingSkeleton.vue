...
<div role="status" class="w-full p-4 rounded shadow animate-pulse md:p-6 border-gray-700">
  <div class="flex items-center justify-center h-64 mb-4 bg-gray-800 rounded">
